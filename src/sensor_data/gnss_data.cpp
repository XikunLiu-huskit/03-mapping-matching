...
//静态成员变量必须在类外初始化
double lidar_localization::GNSSData::origin_longitude = 8.39356963031;
double lidar_localization::GNSSData::origin_latitude = 48.981403728;
double lidar_localization::GNSSData::origin_altitude = 115.932748795;
...
void GNSSData::InitOriginPosition() {
    ...
    origin_longitude = 8.39356963031;
    origin_latitude = 48.981403728;
    origin_altitude = 115.932748795;
